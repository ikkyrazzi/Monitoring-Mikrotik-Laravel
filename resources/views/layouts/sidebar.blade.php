    ...
    <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
            ...
            <ul class="nav nav-primary">
                ...
                <li class="nav-item {{ Request::routeIs('pppoe.secret') ? 'active' : '' }}">
                ...
                <li class="nav-item {{ Request::routeIs('hotspot.users') ? 'active' : '' }}">
                ...
                <li class="nav-item {{ Request::routeIs('traffic.index') ? 'active' : '' }}">
